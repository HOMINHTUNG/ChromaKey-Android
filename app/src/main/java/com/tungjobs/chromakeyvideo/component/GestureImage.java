package com.tungjobs.chromakeyvideo.component;
...
public class GestureImage extends ImageView {
    ...
    public interface OnStartRotationListener {
         ...
         */
        public boolean onStartRotation(GestureImage view);
    }
     ...
     * @param context
     */
    public GestureImage(final Context context) {
        super(context);
        // nothing to do now
    }
     ...
     * @param attrs
     */
    public GestureImage(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        // nothing to do now
    }
     ...
     * @param defStyle
     */
    public GestureImage(final Context context, final AttributeSet attrs, final int defStyle) {
