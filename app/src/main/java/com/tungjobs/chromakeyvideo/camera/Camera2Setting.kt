...
import jp.co.cyberagent.android.gpuimage.sample.utils.generateNV21Data

@RequiresApi(Build.VERSION_CODES.LOLLIPOP)
class Camera2Setting(private val activity: Activity) : CameraLoader() {
    ...
    companion object {
        private const val TAG = "Camera2Setting"
